...
public class AuthController : ControllerBase
{
    ...
    public AuthController(BlastDeckDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
    ...
    public async Task<IActionResult> Register(RegistrationDTO registration)
    {
        ...
        if (result.Succeeded)
        {
            _dbContext.UserProfiles.Add(new UserProfile { IdentityUserId = user.Id, });
